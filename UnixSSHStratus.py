#!/usr/bin/python
#---------------------------------------------------
#   UnisSSH Stratus Change Password
#   V1.0
#
# Stratus Change 
# Created : May, 2020 
...
def Main():
    ...
    # Password Logon or Password Verify
    #if (args.action=="verifylogon"):
    #   connectionSSH = UnixSSHConnection(args.address,22,args.username, args.password)
    #   connectionSSH.logon()
    #   print('Successfull Login')
    #   connectionSSH.logoff()
    
    # Password Change
    #if (args.action=="changepass"):
    #     connectionSSH = UnixSSHConnection(args.address,22,args.username, args.password)
    #     sleep(8) 
    #     print('set_registration_info ' + str(args.username) + ' -password ' + str(args.newpassword))
    #     connectionSSH.changepass('set_registration_info ' + str(args.username) + ' -password ' + str(args.newpassword))
    #     print('Successfull Change')
    #     connectionSSH.logoff()
         
    # Password Reconciliate
    #if (args.action=="reconpass"):
    #     connectionSSH = UnixSSHConnection(args.address,22,args.logonusername, args.logonpassword)
    #     sleep(8) 
    #     connectionSSH.changepass('set_registration_info ' + str(args.username) + ' -password ' + str(args.newpassword))
    #     print('Successfull Reconciliate')
    #     connectionSSH.logoff()
